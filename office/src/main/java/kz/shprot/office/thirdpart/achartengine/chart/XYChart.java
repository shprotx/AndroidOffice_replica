 ...
 */
package kz.shprot.office.thirdpart.achartengine.chart;
...
import kz.shprot.office.thirdpart.achartengine.renderers.BasicStroke;
...
import kz.shprot.office.thirdpart.achartengine.renderers.XYMultipleSeriesRenderer.Orientation;
...
public abstract class XYChart extends AbstractChart {
   ...
   * 
   *(non-Javadoc)
   * @see kz.shprot.office.thirdpart.achartengine.chart.AbstractChart#setZoomRate(float)
   *
   */
  @Override
