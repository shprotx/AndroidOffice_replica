...
public final class HSSFRichTextString implements Comparable<HSSFRichTextString>, RichTextString {
    ...
    private kz.shprot.office.fc.hssf.record.UnicodeString _string;
    ...
    public HSSFRichTextString(String string) {
        if (string == null) {
            _string = new kz.shprot.office.fc.hssf.record.UnicodeString("");
        } else {
            _string = new kz.shprot.office.fc.hssf.record.UnicodeString(string);
        }
    }
     ...
     */
    private kz.shprot.office.fc.hssf.record.UnicodeString cloneStringIfRequired() {
      if (_book == null)
        return _string;
        kz.shprot.office.fc.hssf.record.UnicodeString s = (kz.shprot.office.fc.hssf.record.UnicodeString)_string.clone();
      return s;
    }
     ...
     */
    public kz.shprot.office.fc.hssf.record.UnicodeString getUnicodeString() {
    ...
    void setUnicodeString(kz.shprot.office.fc.hssf.record.UnicodeString str) {
      this._string = str;
    }
