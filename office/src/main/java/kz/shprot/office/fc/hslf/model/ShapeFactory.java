...
public final class ShapeFactory
{
    ...
    protected static kz.shprot.office.fc.hslf.record.Record getClientDataRecord(EscherContainerRecord spContainer, int recordType)
    {
        kz.shprot.office.fc.hslf.record.Record oep = null;
