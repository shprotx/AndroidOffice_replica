...
import kz.shprot.office.fc.hssf.record.CommonObjectDataSubRecord;
...
import kz.shprot.office.fc.hssf.record.aggregates.FormulaRecordAggregate;
import kz.shprot.office.fc.hssf.record.common.UnicodeString;
import kz.shprot.office.fc.ss.SpreadsheetVersion;
import kz.shprot.office.fc.ss.usermodel.Comment;
import kz.shprot.office.fc.ss.usermodel.FormulaError;
import kz.shprot.office.fc.ss.usermodel.ICell;
import kz.shprot.office.fc.ss.usermodel.ICellStyle;
import kz.shprot.office.fc.ss.usermodel.IHyperlink;
import kz.shprot.office.fc.ss.usermodel.RichTextString;
import kz.shprot.office.fc.ss.util.CellReference;
import kz.shprot.office.fc.ss.util.HSSFCellRangeAddress;
import kz.shprot.office.fc.ss.util.NumberToTextConverter;
...
public class HSSFCell implements ICell {
     ...
     *
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFRow#createCell(short)
     */
     ...
     *                Type of cell
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFRow#createCell(short,int)
     */
    ...
    private static int determineType(CellValueRecordInterface cval) {
        ...
        kz.shprot.office.fc.hssf.record.Record record = ( kz.shprot.office.fc.hssf.record.Record ) cval;
        ...
        switch (cellType)
        {
            ...
            case CELL_TYPE_STRING :
                ...
                if (setValue) {
                    ...
                    int sstIndex = _book.getWorkbook().addSSTString(new kz.shprot.office.fc.hssf.record.UnicodeString(str));
                    lrec.setSSTIndex(sstIndex);
                    kz.shprot.office.fc.hssf.record.UnicodeString us = _book.getWorkbook().getSSTString(sstIndex);
    ...
    public void setCellValue(RichTextString value)
    {
        ...
        kz.shprot.office.fc.hssf.record.UnicodeString str = hvalue.getUnicodeString();
...
//        agg.setParsedExpression(ptgs);
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook#createCellStyle()
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook#getCellStyleAt(short)
     */
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFSheet#shiftRows(int, int, int)
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFSheet#addMergedRegion(kz.shprot.office.fc.ss.util.HSSFCellRangeAddress)
