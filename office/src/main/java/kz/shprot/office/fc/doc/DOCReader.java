...
package kz.shprot.office.fc.doc;
...
import kz.shprot.office.common.bookmark.Bookmark;
import kz.shprot.office.common.borders.Border;
import kz.shprot.office.common.borders.Borders;
import kz.shprot.office.common.borders.Line;
import kz.shprot.office.common.bulletnumber.ListData;
import kz.shprot.office.common.bulletnumber.ListLevel;
import kz.shprot.office.common.hyperlink.Hyperlink;
import kz.shprot.office.common.picture.Picture;
...
import kz.shprot.office.common.shape.WPAbstractShape;
import kz.shprot.office.common.shape.WPAutoShape;
import kz.shprot.office.common.shape.WPGroupShape;
import kz.shprot.office.common.shape.WPPictureShape;
...
import kz.shprot.office.fc.ddf.EscherTextboxRecord;
import kz.shprot.office.fc.hwpf.HWPFDocument;
import kz.shprot.office.fc.hwpf.model.FieldsDocumentPart;
import kz.shprot.office.fc.hwpf.model.ListFormatOverride;
import kz.shprot.office.fc.hwpf.model.ListTables;
import kz.shprot.office.fc.hwpf.model.POIListData;
import kz.shprot.office.fc.hwpf.model.POIListLevel;
import kz.shprot.office.fc.hwpf.model.PicturesTable;
import kz.shprot.office.fc.hwpf.usermodel.Bookmarks;
import kz.shprot.office.fc.hwpf.usermodel.BorderCode;
import kz.shprot.office.fc.hwpf.usermodel.CharacterRun;
import kz.shprot.office.fc.hwpf.usermodel.Field;
import kz.shprot.office.fc.hwpf.usermodel.HWPFAutoShape;
import kz.shprot.office.fc.hwpf.usermodel.HWPFShape;
import kz.shprot.office.fc.hwpf.usermodel.HWPFShapeGroup;
import kz.shprot.office.fc.hwpf.usermodel.HeaderStories;
import kz.shprot.office.fc.hwpf.usermodel.InlineWordArt;
import kz.shprot.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import kz.shprot.office.fc.hwpf.usermodel.OfficeDrawing;
import kz.shprot.office.fc.hwpf.usermodel.OfficeDrawings;
import kz.shprot.office.fc.hwpf.usermodel.POIBookmark;
import kz.shprot.office.fc.hwpf.usermodel.Paragraph;
import kz.shprot.office.fc.hwpf.usermodel.PictureType;
import kz.shprot.office.fc.hwpf.usermodel.Range;
import kz.shprot.office.fc.hwpf.usermodel.Section;
import kz.shprot.office.fc.hwpf.usermodel.Table;
import kz.shprot.office.fc.hwpf.usermodel.TableCell;
import kz.shprot.office.fc.hwpf.usermodel.TableRow;
import kz.shprot.office.fc.util.LittleEndian;
import kz.shprot.office.java.awt.Rectangle;
import kz.shprot.office.java.util.Arrays;
...
import kz.shprot.office.simpletext.view.PageAttr;
import kz.shprot.office.ss.util.ModelUtil;
import kz.shprot.office.system.AbstractReader;
import kz.shprot.office.system.IControl;
import kz.shprot.office.wp.model.CellElement;
import kz.shprot.office.wp.model.HFElement;
import kz.shprot.office.wp.model.RowElement;
import kz.shprot.office.wp.model.TableElement;
import kz.shprot.office.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	kz.shprot.office.java.awt.Color fillColor = shape.getForegroundColor();
            	kz.shprot.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            kz.shprot.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            kz.shprot.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
