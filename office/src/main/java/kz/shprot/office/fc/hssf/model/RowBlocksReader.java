...
import kz.shprot.office.fc.hssf.record.aggregates.SharedValueManager;
...
public final class RowBlocksReader {
	...
	public RowBlocksReader(RecordStream rs) {
		List<kz.shprot.office.fc.hssf.record.Record> plainRecords = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();
		List<kz.shprot.office.fc.hssf.record.Record> shFrmRecords = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();
		List<CellReference> firstCellRefs = new ArrayList<CellReference>();
		List<kz.shprot.office.fc.hssf.record.Record> arrayRecords = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();
		List<kz.shprot.office.fc.hssf.record.Record> tableRecords = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();
		List<kz.shprot.office.fc.hssf.record.Record> mergeCellRecords = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();

		kz.shprot.office.fc.hssf.record.Record prevRec = null;
		while(!RecordOrderer.isEndOfRowBlock(rs.peekNextSid())) {
			...
			List<kz.shprot.office.fc.hssf.record.Record> dest;
			switch (rec.getSid()) {
