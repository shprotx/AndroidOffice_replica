...
import kz.shprot.office.fc.hssf.record.ObjectProtectRecord;
...
import kz.shprot.office.fc.hssf.record.ScenarioProtectRecord;
...
public final class WorksheetProtectionBlock extends RecordAggregate {
	...
	private void checkNotPresent(kz.shprot.office.fc.hssf.record.Record rec) {
		if (rec != null) {
	...
	private static void visitIfPresent(kz.shprot.office.fc.hssf.record.Record r, RecordVisitor rv) {
		if (r != null) {
			rv.visitRecord(r);
		}
	}
