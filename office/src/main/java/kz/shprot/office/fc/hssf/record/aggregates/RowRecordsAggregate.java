...
import kz.shprot.office.fc.hssf.record.DBCellRecord;
...
import kz.shprot.office.fc.hssf.record.MulBlankRecord;
...
public final class RowRecordsAggregate extends RecordAggregate {
	...
	private final List<kz.shprot.office.fc.hssf.record.Record> _unknownRecords;
	...
	private RowRecordsAggregate(SharedValueManager svm) {
		...
		_unknownRecords = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();
	...
	public RowRecordsAggregate(RecordStream rs, SharedValueManager svm) {
		this(svm);
		while(rs.hasNext()) {
			kz.shprot.office.fc.hssf.record.Record rec = rs.getNext();
			switch (rec.getSid()) {
				case RowRecord.sid:
	 ...
	 */
	private void addUnknownRecord(kz.shprot.office.fc.hssf.record.Record rec) {
	...
	private int visitRowRecordsForBlock(int blockIndex, RecordVisitor rv) {
		...
		while(rowIterator.hasNext() && (i++ < endIndex)) {
			kz.shprot.office.fc.hssf.record.Record rec = (kz.shprot.office.fc.hssf.record.Record)rowIterator.next();
