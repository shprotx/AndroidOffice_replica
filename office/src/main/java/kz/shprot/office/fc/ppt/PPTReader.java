 ...
 * 时间:               下午4:23:51
 */
package kz.shprot.office.fc.ppt;
...
import kz.shprot.office.common.PaintKit;
import kz.shprot.office.common.autoshape.ExtendPath;
import kz.shprot.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import kz.shprot.office.common.bg.BackgroundAndFill;
import kz.shprot.office.common.bg.Gradient;
import kz.shprot.office.common.bg.LinearGradientShader;
import kz.shprot.office.common.bg.RadialGradientShader;
import kz.shprot.office.common.bg.TileShader;
import kz.shprot.office.common.hyperlink.Hyperlink;
import kz.shprot.office.common.pictureefftect.PictureEffectInfoFactory;
import kz.shprot.office.common.shape.AbstractShape;
import kz.shprot.office.common.shape.ArbitraryPolygonShape;
import kz.shprot.office.common.shape.Arrow;
import kz.shprot.office.common.shape.AutoShape;
import kz.shprot.office.common.shape.GroupShape;
import kz.shprot.office.common.shape.IShape;
import kz.shprot.office.common.shape.LineShape;
import kz.shprot.office.common.shape.PictureShape;
import kz.shprot.office.common.shape.ShapeTypes;
import kz.shprot.office.common.shape.TableCell;
import kz.shprot.office.common.shape.TableShape;
import kz.shprot.office.common.shape.TextBox;
import kz.shprot.office.constant.AutoShapeConstant;
import kz.shprot.office.constant.EventConstant;
import kz.shprot.office.constant.MainConstant;
import kz.shprot.office.constant.wp.WPAttrConstant;
import kz.shprot.office.constant.wp.WPModelConstant;
import kz.shprot.office.fc.FCKit;
import kz.shprot.office.fc.ShapeKit;
import kz.shprot.office.fc.hslf.HSLFSlideShow;
import kz.shprot.office.fc.hslf.model.Fill;
import kz.shprot.office.fc.hslf.model.HeadersFooters;
import kz.shprot.office.fc.hslf.model.Line;
import kz.shprot.office.fc.hslf.model.MasterSheet;
import kz.shprot.office.fc.hslf.model.Notes;
import kz.shprot.office.fc.hslf.model.Shape;
import kz.shprot.office.fc.hslf.model.ShapeGroup;
import kz.shprot.office.fc.hslf.model.Sheet;
import kz.shprot.office.fc.hslf.model.SimpleShape;
import kz.shprot.office.fc.hslf.model.Slide;
import kz.shprot.office.fc.hslf.model.SlideMaster;
import kz.shprot.office.fc.hslf.model.TextShape;
import kz.shprot.office.fc.hslf.model.TitleMaster;
import kz.shprot.office.fc.hslf.record.BinaryTagDataBlob;
import kz.shprot.office.fc.hslf.record.ClientVisualElementContainer;
import kz.shprot.office.fc.hslf.record.DocumentAtom;
import kz.shprot.office.fc.hslf.record.OEPlaceholderAtom;
import kz.shprot.office.fc.hslf.record.PositionDependentRecordContainer;
import kz.shprot.office.fc.hslf.record.SlideAtom;
import kz.shprot.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import kz.shprot.office.fc.hslf.record.SlideProgBinaryTagContainer;
import kz.shprot.office.fc.hslf.record.SlideProgTagsContainer;
import kz.shprot.office.fc.hslf.record.SlideShowSlideInfoAtom;
import kz.shprot.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeColorBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeCommandBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeEffectBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeMotionBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeNodeAttributeContainer;
import kz.shprot.office.fc.hslf.record.TimeNodeContainer;
import kz.shprot.office.fc.hslf.record.TimeRotationBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeScaleBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeSetBehaviorContainer;
import kz.shprot.office.fc.hslf.record.TimeVariant;
import kz.shprot.office.fc.hslf.record.VisualShapeAtom;
import kz.shprot.office.fc.hslf.usermodel.PictureData;
import kz.shprot.office.fc.hslf.usermodel.RichTextRun;
import kz.shprot.office.fc.hslf.usermodel.SlideShow;
import kz.shprot.office.fc.ppt.bulletnumber.BulletNumberManage;
import kz.shprot.office.java.awt.Dimension;
import kz.shprot.office.java.awt.Rectangle;
import kz.shprot.office.java.awt.Rectanglef;
import kz.shprot.office.java.awt.geom.Rectangle2D;
import kz.shprot.office.pg.animate.ShapeAnimation;
import kz.shprot.office.pg.model.PGModel;
import kz.shprot.office.pg.model.PGNotes;
import kz.shprot.office.pg.model.PGSlide;
import kz.shprot.office.simpletext.font.FontTypefaceManage;
import kz.shprot.office.simpletext.model.AttrManage;
import kz.shprot.office.simpletext.model.IAttributeSet;
import kz.shprot.office.simpletext.model.LeafElement;
import kz.shprot.office.simpletext.model.ParagraphElement;
import kz.shprot.office.simpletext.model.SectionElement;
import kz.shprot.office.ss.util.format.NumericFormatter;
import kz.shprot.office.system.AbstractReader;
import kz.shprot.office.system.BackReaderThread;
...
{   
    ...
    private void processSlideshow(PGSlide pgSlide, SlideProgTagsContainer propTagsContainer)
    {
        try
        {
            ...
            kz.shprot.office.fc.hslf.record.Record[] records = propTagsContainer.getChildRecords();
            ...
            kz.shprot.office.fc.hslf.record.Record rec = ((SlideProgBinaryTagContainer)records[0]).findFirstOfType(BinaryTagDataBlob.RECORD_ID);
            if(rec == null)
            {
                return;
            }
            ...
            if(records != null)
            {
                for(kz.shprot.office.fc.hslf.record.Record record : records)
                {
    ...
    private List<ShapeAnimation> processAnimation(PGSlide pgSlide, TimeNodeContainer timeNodeContainer)
    {
        try
        {
            ...
            kz.shprot.office.fc.hslf.record.Record[] childRecords = timeNodeContainer.getChildRecords();
            ...
            if(timeNodeContainerList.size() > 1)
            {
                ...
                {
                    kz.shprot.office.fc.hslf.record.Record record = container.findFirstOfType(TimeNodeContainer.RECORD_ID);
                    if(record != null)
                    {
    ...
    private ShapeAnimation processSingleAnimation(PGSlide pgSlide, TimeNodeContainer timeNodeContainer)
    {
        try
        {
          //animation type
            ...
            kz.shprot.office.fc.hslf.record.Record[] records = timeNodeAttrContainer.getChildRecords();
            for(kz.shprot.office.fc.hslf.record.Record record : records)
            {
    ...
    private kz.shprot.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private kz.shprot.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        kz.shprot.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             kz.shprot.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new kz.shprot.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	kz.shprot.office.java.awt.Color fillColor = fill.getForegroundColor();
            	kz.shprot.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof kz.shprot.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof kz.shprot.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof kz.shprot.office.fc.hslf.model.Freeform
            || shape instanceof kz.shprot.office.fc.hslf.model.AutoShape
            || shape instanceof kz.shprot.office.fc.hslf.model.TextBox
            || shape instanceof kz.shprot.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof kz.shprot.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((kz.shprot.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((kz.shprot.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((kz.shprot.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof kz.shprot.office.fc.hslf.model.AutoShape
                    || shape instanceof kz.shprot.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof kz.shprot.office.fc.hslf.model.Picture)
            {   
                kz.shprot.office.fc.hslf.model.Picture poiPic = (kz.shprot.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof kz.shprot.office.fc.hslf.model.Table)
        {
            kz.shprot.office.fc.hslf.model.Table poiTable = (kz.shprot.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, kz.shprot.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                kz.shprot.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	kz.shprot.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            kz.shprot.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            kz.shprot.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != kz.shprot.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
        kz.shprot.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        kz.shprot.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(kz.shprot.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
