...
import kz.shprot.office.fc.hssf.record.AutoFilterInfoRecord;
import kz.shprot.office.fc.hssf.record.CellValueRecordInterface;
import kz.shprot.office.fc.hssf.record.DVRecord;
...
import kz.shprot.office.fc.hssf.util.Region;
import kz.shprot.office.fc.ss.SpreadsheetVersion;
import kz.shprot.office.fc.ss.usermodel.CellRange;
import kz.shprot.office.fc.ss.usermodel.DataValidation;
import kz.shprot.office.fc.ss.usermodel.DataValidationHelper;
import kz.shprot.office.fc.ss.usermodel.ICell;
import kz.shprot.office.fc.ss.usermodel.ICellStyle;
import kz.shprot.office.fc.ss.usermodel.IRow;
import kz.shprot.office.fc.ss.util.CellReference;
import kz.shprot.office.fc.ss.util.HSSFCellRangeAddress;
import kz.shprot.office.fc.ss.util.SSCellRange;
import kz.shprot.office.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements kz.shprot.office.fc.ss.usermodel.Sheet
{
    ...
    private void setPropertiesFromSheet(InternalSheet sheet)
    {
        ...
        while (iter.hasNext())
        {
            ...
            if (log.check(POILogger.DEBUG))
                log.log(DEBUG, "record id = " + Integer.toHexString(((kz.shprot.office.fc.hssf.record.Record)cval).getSid()));
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFRow
     */
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(kz.shprot.office.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with is the
     ...
     *
     * @see kz.shprot.office.ss.model.baseModel
     */
    ...
    protected void insertChartRecords(List<kz.shprot.office.fc.hssf.record.Record> records)
    {
