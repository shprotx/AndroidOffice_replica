...
import kz.shprot.office.fc.hssf.formula.CollaboratingWorkbooksEnvironment;
import kz.shprot.office.fc.hssf.formula.IStabilityClassifier;
import kz.shprot.office.fc.hssf.formula.WorkbookEvaluator;
...
import kz.shprot.office.fc.ss.usermodel.CellValue;
import kz.shprot.office.fc.ss.usermodel.FormulaEvaluator;
import kz.shprot.office.fc.ss.usermodel.ICell;
import kz.shprot.office.fc.ss.usermodel.Workbook;
...
public class HSSFFormulaEvaluator implements FormulaEvaluator
{
     ...
     * replaced with the result of the formula, use {@link #evaluateInCell(com.kz.shprot.office.fc.ss.usermodel.ICell)}
