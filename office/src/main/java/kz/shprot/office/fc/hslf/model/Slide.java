...
import kz.shprot.office.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(kz.shprot.office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new kz.shprot.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see kz.shprot.office.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public kz.shprot.office.fc.hslf.record.Slide getSlideRecord()
    {
        return (kz.shprot.office.fc.hslf.record.Slide)getSheetContainer();
    }
