...
import kz.shprot.office.fc.hssf.record.CRNCountRecord;
import kz.shprot.office.fc.hssf.record.CRNRecord;
import kz.shprot.office.fc.hssf.record.CountryRecord;
import kz.shprot.office.fc.hssf.record.ExternSheetRecord;
import kz.shprot.office.fc.hssf.record.ExternalNameRecord;
...
final class LinkTable {
	...
	private static final class ExternalBookBlock {
         ...
         *
         * @see kz.shprot.office.fc.hssf.model.LinkTable#LinkTable(int, WorkbookRecordList)
         */
         ...
         *
         * @see kz.shprot.office.fc.hssf.model.LinkTable#addNameXPtg(String)
         */
	...
	private int findFirstRecordLocBySid(short sid) {
		...
		for (Iterator iterator = _workbookRecordList.iterator(); iterator.hasNext(); ) {
			kz.shprot.office.fc.hssf.record.Record record = ( kz.shprot.office.fc.hssf.record.Record ) iterator.next();
