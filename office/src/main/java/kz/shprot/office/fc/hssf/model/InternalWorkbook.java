...
import kz.shprot.office.fc.ddf.EscherBSERecord;
import kz.shprot.office.fc.ddf.EscherBoolProperty;
import kz.shprot.office.fc.ddf.EscherContainerRecord;
import kz.shprot.office.fc.ddf.EscherDgRecord;
import kz.shprot.office.fc.ddf.EscherDggRecord;
import kz.shprot.office.fc.ddf.EscherOptRecord;
import kz.shprot.office.fc.ddf.EscherProperties;
import kz.shprot.office.fc.ddf.EscherRGBProperty;
...
import kz.shprot.office.fc.ddf.EscherSplitMenuColorsRecord;
import kz.shprot.office.fc.hssf.formula.EvaluationWorkbook.ExternalName;
import kz.shprot.office.fc.hssf.formula.EvaluationWorkbook.ExternalSheet;
import kz.shprot.office.fc.hssf.formula.FormulaShifter;
import kz.shprot.office.fc.hssf.formula.ptg.Area3DPtg;
import kz.shprot.office.fc.hssf.formula.ptg.NameXPtg;
import kz.shprot.office.fc.hssf.formula.ptg.OperandPtg;
import kz.shprot.office.fc.hssf.formula.ptg.Ptg;
import kz.shprot.office.fc.hssf.formula.ptg.Ref3DPtg;
import kz.shprot.office.fc.hssf.formula.udf.UDFFinder;
import kz.shprot.office.fc.hssf.record.BOFRecord;
import kz.shprot.office.fc.hssf.record.BackupRecord;
import kz.shprot.office.fc.hssf.record.BookBoolRecord;
import kz.shprot.office.fc.hssf.record.BoundSheetRecord;
import kz.shprot.office.fc.hssf.record.CodepageRecord;
import kz.shprot.office.fc.hssf.record.CountryRecord;
import kz.shprot.office.fc.hssf.record.DSFRecord;
import kz.shprot.office.fc.hssf.record.DateWindow1904Record;
import kz.shprot.office.fc.hssf.record.DrawingGroupRecord;
import kz.shprot.office.fc.hssf.record.EOFRecord;
import kz.shprot.office.fc.hssf.record.EscherAggregate;
import kz.shprot.office.fc.hssf.record.ExtSSTRecord;
import kz.shprot.office.fc.hssf.record.ExtendedFormatRecord;
import kz.shprot.office.fc.hssf.record.ExternSheetRecord;
import kz.shprot.office.fc.hssf.record.FileSharingRecord;
import kz.shprot.office.fc.hssf.record.FnGroupCountRecord;
import kz.shprot.office.fc.hssf.record.FontRecord;
import kz.shprot.office.fc.hssf.record.FormatRecord;
import kz.shprot.office.fc.hssf.record.HideObjRecord;
import kz.shprot.office.fc.hssf.record.HyperlinkRecord;
import kz.shprot.office.fc.hssf.record.InterfaceEndRecord;
import kz.shprot.office.fc.hssf.record.InterfaceHdrRecord;
import kz.shprot.office.fc.hssf.record.MMSRecord;
import kz.shprot.office.fc.hssf.record.NameCommentRecord;
import kz.shprot.office.fc.hssf.record.NameRecord;
import kz.shprot.office.fc.hssf.record.PaletteRecord;
import kz.shprot.office.fc.hssf.record.PasswordRecord;
import kz.shprot.office.fc.hssf.record.PasswordRev4Record;
import kz.shprot.office.fc.hssf.record.PrecisionRecord;
import kz.shprot.office.fc.hssf.record.ProtectRecord;
import kz.shprot.office.fc.hssf.record.ProtectionRev4Record;
import kz.shprot.office.fc.hssf.record.RecalcIdRecord;
import kz.shprot.office.fc.hssf.record.Record;
import kz.shprot.office.fc.hssf.record.RefreshAllRecord;
import kz.shprot.office.fc.hssf.record.SSTRecord;
import kz.shprot.office.fc.hssf.record.StyleRecord;
import kz.shprot.office.fc.hssf.record.SupBookRecord;
import kz.shprot.office.fc.hssf.record.TabIdRecord;
import kz.shprot.office.fc.hssf.record.UseSelFSRecord;
import kz.shprot.office.fc.hssf.record.WindowOneRecord;
import kz.shprot.office.fc.hssf.record.WindowProtectRecord;
import kz.shprot.office.fc.hssf.record.WriteAccessRecord;
import kz.shprot.office.fc.hssf.record.WriteProtectRecord;
import kz.shprot.office.fc.hssf.record.common.UnicodeString;
import kz.shprot.office.fc.hssf.util.HSSFColor;
import kz.shprot.office.fc.ss.usermodel.BuiltinFormats;
import kz.shprot.office.fc.util.Internal;
import kz.shprot.office.fc.util.POILogFactory;
import kz.shprot.office.fc.util.POILogger;
 ...
 * @see kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
     ...
     */
    public static InternalWorkbook createWorkbook(List<kz.shprot.office.fc.hssf.record.Record> recs, AbstractReader iAbortListener)
    {
        InternalWorkbook retval = new InternalWorkbook();
        List<kz.shprot.office.fc.hssf.record.Record> records = new ArrayList<Record>(recs.size() / 3);
    ...
    public int addSSTString(kz.shprot.office.fc.hssf.record.UnicodeString string)
    {
        if (log.check(POILogger.DEBUG))
    ...
    public kz.shprot.office.fc.hssf.record.UnicodeString getSSTString(int str)
    {
        if (sst == null)
        {
            insertSST();
        }
        kz.shprot.office.fc.hssf.record.UnicodeString retval = sst.getString(str);
     ...
     * @see kz.shprot.office.fc.hssf.record.SSTRecord
     */
     ...
     * @see kz.shprot.office.fc.hssf.record.BoundSheetRecord
     * @see kz.shprot.office.fc.hssf.record.Record
     */
     ...
     * @see kz.shprot.office.fc.hssf.record.FormatRecord
     * @see kz.shprot.office.fc.hssf.record.Record
     */
    ...
    */
    ...
    public DrawingManager2 findDrawingGroup()
    {
        ...
        for (kz.shprot.office.fc.hssf.record.Record r : records)
        {
     ...
     *
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
