...
package kz.shprot.office.fc.hssf.record.cf;


import kz.shprot.office.fc.hssf.record.RecordInputStream;
import kz.shprot.office.fc.util.BitField;
import kz.shprot.office.fc.util.BitFieldFactory;
...
public final class FontFormatting
{
	 ...
	 * @see #setFontOption(boolean, kz.shprot.office.fc.util.BitField)
	 */
	 ...
	 * @see #getFontOption(kz.shprot.office.fc.util.BitField)
	 */
	 ...
	 * @see kz.shprot.office.fc.hssf.usermodel.HSSFFontFormatting#SS_NONE
	 * @see kz.shprot.office.fc.hssf.usermodel.HSSFFontFormatting#SS_SUPER
	 * @see kz.shprot.office.fc.hssf.usermodel.HSSFFontFormatting#SS_SUB
	 */
	 ...
	 *
	 * @see kz.shprot.office.fc.hssf.usermodel.HSSFFontFormatting#U_NONE
	 * @see kz.shprot.office.fc.hssf.usermodel.HSSFFontFormatting#U_SINGLE
	 * @see kz.shprot.office.fc.hssf.usermodel.HSSFFontFormatting#U_DOUBLE
	 * @see kz.shprot.office.fc.hssf.usermodel.HSSFFontFormatting#U_SINGLE_ACCOUNTING
	 * @see kz.shprot.office.fc.hssf.usermodel.HSSFFontFormatting#U_DOUBLE_ACCOUNTING
	 */
