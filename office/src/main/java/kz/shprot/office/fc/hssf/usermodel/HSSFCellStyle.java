...
import kz.shprot.office.fc.ss.usermodel.IFont;
 ...
 * @see kz.shprot.office.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(kz.shprot.office.fc.ss.usermodel.Workbook workbook) {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(kz.shprot.office.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFPalette#getColor(short)
