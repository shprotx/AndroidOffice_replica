...
import kz.shprot.office.fc.hpsf.DocumentSummaryInformation;
import kz.shprot.office.fc.hpsf.MutablePropertySet;
import kz.shprot.office.fc.hpsf.PropertySet;
import kz.shprot.office.fc.hpsf.PropertySetFactory;
import kz.shprot.office.fc.hpsf.SummaryInformation;
import kz.shprot.office.fc.poifs.filesystem.DirectoryEntry;
import kz.shprot.office.fc.poifs.filesystem.DirectoryNode;
import kz.shprot.office.fc.poifs.filesystem.DocumentInputStream;
import kz.shprot.office.fc.poifs.filesystem.Entry;
import kz.shprot.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import kz.shprot.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(kz.shprot.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(kz.shprot.office.fc.hpsf.WritingNotSupportedException wnse)
        {
