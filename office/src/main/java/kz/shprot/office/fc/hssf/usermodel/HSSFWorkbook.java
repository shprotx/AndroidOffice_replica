...
import kz.shprot.office.fc.POIDocument;
import kz.shprot.office.fc.codec.DigestUtils;
import kz.shprot.office.fc.ddf.EscherBSERecord;
import kz.shprot.office.fc.ddf.EscherBitmapBlip;
import kz.shprot.office.fc.ddf.EscherBlipRecord;
import kz.shprot.office.fc.ddf.EscherRecord;
import kz.shprot.office.fc.hssf.OldExcelFormatException;
import kz.shprot.office.fc.hssf.formula.FormulaShifter;
import kz.shprot.office.fc.hssf.formula.SheetNameFormatter;
import kz.shprot.office.fc.hssf.formula.ptg.Area3DPtg;
import kz.shprot.office.fc.hssf.formula.ptg.MemFuncPtg;
import kz.shprot.office.fc.hssf.formula.ptg.Ptg;
import kz.shprot.office.fc.hssf.formula.ptg.UnionPtg;
import kz.shprot.office.fc.hssf.formula.udf.AggregatingUDFFinder;
import kz.shprot.office.fc.hssf.formula.udf.UDFFinder;
import kz.shprot.office.fc.hssf.model.DrawingManager2;
import kz.shprot.office.fc.hssf.model.InternalSheet;
import kz.shprot.office.fc.hssf.model.InternalWorkbook;
import kz.shprot.office.fc.hssf.model.RecordStream;
import kz.shprot.office.fc.hssf.record.AbstractEscherHolderRecord;
import kz.shprot.office.fc.hssf.record.BackupRecord;
import kz.shprot.office.fc.hssf.record.DrawingGroupRecord;
import kz.shprot.office.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import kz.shprot.office.fc.hssf.record.RecordFactory;
import kz.shprot.office.fc.hssf.record.SSTRecord;
import kz.shprot.office.fc.hssf.record.SubRecord;
...
import kz.shprot.office.fc.hssf.util.CellReference;
import kz.shprot.office.fc.poifs.filesystem.DirectoryNode;
import kz.shprot.office.fc.poifs.filesystem.POIFSFileSystem;
import kz.shprot.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import kz.shprot.office.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements kz.shprot.office.fc.ss.usermodel.Workbook
{
    ...
    public HSSFWorkbook(DirectoryNode directory, boolean preserveNodes) throws IOException
    {
        ...
        List<kz.shprot.office.fc.hssf.record.Record> records = RecordFactory.createRecords(stream);
...
//            names.add(name);
    ...
    private void convertLabelRecords(List records, int offset)
    {
        ...
        {
            kz.shprot.office.fc.hssf.record.Record rec = (kz.shprot.office.fc.hssf.record.Record)records.get(k);
            ...
            if (rec.getSid() == LabelRecord.sid)
            {
                ...
                int stringid = workbook.addSSTString(new kz.shprot.office.fc.hssf.record.UnicodeString(oldrec.getValue()));
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     */
    public int getSheetIndex(kz.shprot.office.fc.ss.usermodel.Sheet sheet)
    {
...
//            names.add(newName);
    ...
    private static final class SheetRecordCollector implements RecordVisitor
    {
        ...
        public void visitRecord(kz.shprot.office.fc.hssf.record.Record r)
        {
            _list.add(r);
        ...
        public int serialize(int offset, byte[] data)
        {
            ...
            {
                kz.shprot.office.fc.hssf.record.Record rec = (kz.shprot.office.fc.hssf.record.Record)_list.get(i);
    ...
    {
        return workbook.addSSTString(new kz.shprot.office.fc.hssf.record.UnicodeString(string));
    }
...
//        return newName;
    ...
    public List<HSSFPictureData> getAllPictures()
    {
        ...
        Iterator<kz.shprot.office.fc.hssf.record.Record> recordIter = workbook.getRecords().iterator();
        while (recordIter.hasNext())
        {
            kz.shprot.office.fc.hssf.record.Record r = recordIter.next();
