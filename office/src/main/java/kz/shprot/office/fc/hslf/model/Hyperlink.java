...
public final class Hyperlink
{
    ...
    protected static Hyperlink[] find(TextRun run)
    {
        ...
        kz.shprot.office.fc.hslf.record.Record[] records = run._records;
        if (records != null)
    ...
    protected static Hyperlink find(Shape shape)
    {
        ...
        for (Iterator<EscherRecord> it = spContainer.getChildIterator(); it.hasNext();)
        {
            ...
            if (obj.getRecordId() == EscherClientDataRecord.RECORD_ID)
            {
                ...
                kz.shprot.office.fc.hslf.record.Record[] records = kz.shprot.office.fc.hslf.record.Record.findChildRecords(data, 8, data.length - 8);
                if (records != null)
                    find(records, exobj, lst);
            }
        }
    ...
    private static void find(kz.shprot.office.fc.hslf.record.Record[] records, ExObjList exobj, List out)
    {
