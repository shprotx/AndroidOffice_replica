...
package kz.shprot.office.fc.hslf.usermodel;
...
import kz.shprot.office.fc.hslf.exceptions.CorruptPowerPointFileException;
import kz.shprot.office.fc.hslf.model.HeadersFooters;
import kz.shprot.office.fc.hslf.model.Hyperlink;
import kz.shprot.office.fc.hslf.model.MovieShape;
...
import kz.shprot.office.fc.hslf.record.Document;
import kz.shprot.office.fc.hslf.record.DocumentAtom;
import kz.shprot.office.fc.hslf.record.ExAviMovie;
import kz.shprot.office.fc.hslf.record.ExControl;
import kz.shprot.office.fc.hslf.record.ExHyperlink;
import kz.shprot.office.fc.hslf.record.ExHyperlinkAtom;
import kz.shprot.office.fc.hslf.record.ExMCIMovie;
import kz.shprot.office.fc.hslf.record.ExObjList;
import kz.shprot.office.fc.hslf.record.ExObjListAtom;
import kz.shprot.office.fc.hslf.record.ExOleObjAtom;
import kz.shprot.office.fc.hslf.record.ExVideoContainer;
import kz.shprot.office.fc.hslf.record.ExtendedParagraphHeaderAtom;
import kz.shprot.office.fc.hslf.record.ExtendedPresRuleContainer;
import kz.shprot.office.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import kz.shprot.office.fc.hslf.record.FontCollection;
import kz.shprot.office.fc.hslf.record.HeadersFootersContainer;
import kz.shprot.office.fc.hslf.record.PersistPtrHolder;
import kz.shprot.office.fc.hslf.record.PositionDependentRecord;
import kz.shprot.office.fc.hslf.record.PositionDependentRecordContainer;
import kz.shprot.office.fc.hslf.record.RecordContainer;
import kz.shprot.office.fc.hslf.record.RecordTypes;
import kz.shprot.office.fc.hslf.record.SlideListWithText;
import kz.shprot.office.fc.hslf.record.SlideListWithText.SlideAtomsSet;
import kz.shprot.office.fc.hslf.record.SlidePersistAtom;
...
public final class SlideShow
{
    ...
    public SlideShow(HSLFSlideShow hslfSlideShow, boolean isGetThumbnail)
    {
        ...
        for (kz.shprot.office.fc.hslf.record.Record record : _records)
        {
    ...
    private void findMostRecentCoreRecords()
    {
        ...
        // the array
        _mostRecentCoreRecords = new kz.shprot.office.fc.hslf.record.Record[mostRecentByBytes.size()];
     ...
     */
    private kz.shprot.office.fc.hslf.record.Record getCoreRecordForSAS(SlideAtomsSet sas)
    {
     ...
     *            the refID
     */
    private kz.shprot.office.fc.hslf.record.Record getCoreRecordForRefID(int refID)
    {
        Integer coreRecordId = _sheetIdToCoreRecordsLookup.get(Integer.valueOf(refID));
        if (coreRecordId != null)
        {
            kz.shprot.office.fc.hslf.record.Record r = _mostRecentCoreRecords[coreRecordId.intValue()];
            return r;
        }
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            {
                kz.shprot.office.fc.hslf.record.Record r = getCoreRecordForSAS(masterSets[i]);
                SlideAtomsSet sas = masterSets[i];
                int sheetNo = sas.getSlidePersistAtom().getSlideIdentifier();
                if (r instanceof kz.shprot.office.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((kz.shprot.office.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof kz.shprot.office.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((kz.shprot.office.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
        kz.shprot.office.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new kz.shprot.office.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<kz.shprot.office.fc.hslf.record.Notes> notesRecordsL = new ArrayList<kz.shprot.office.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                // Get the right core record
                kz.shprot.office.fc.hslf.record.Record r = getCoreRecordForSAS(notesSets[i]);

                // Ensure it really is a notes record
                if (r instanceof kz.shprot.office.fc.hslf.record.Notes)
                {
                    kz.shprot.office.fc.hslf.record.Notes notesRecord = (kz.shprot.office.fc.hslf.record.Notes)r;
            ...
            notesRecords = new kz.shprot.office.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
        kz.shprot.office.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new kz.shprot.office.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new kz.shprot.office.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                // Get the right core record
                kz.shprot.office.fc.hslf.record.Record r = getCoreRecordForSAS(slidesSets[i]);

                // Ensure it really is a slide record
                if (r instanceof kz.shprot.office.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (kz.shprot.office.fc.hslf.record.Slide)r;
                }
                /*else
                {
     ...
     * records
     */
    public kz.shprot.office.fc.hslf.record.Record[] getMostRecentCoreRecords()
    {
    ...
    public Dimension getPageSize()
    {
        ...
        Log.d("Dimension","x: " + docatom.getSlideSizeX() + ", y: " + docatom.getSlideSizeY());
    ...
    public void reorderSlide(int oldSlideNumber, int newSlideNumber)
    {
        ...
        for (int i = 0; i < sas.length; i++)
        {
            ...
            kz.shprot.office.fc.hslf.record.Record[] r = sas[i].getSlideRecords();
        ...
        kz.shprot.office.fc.hslf.record.Record[] r = lst.toArray(new kz.shprot.office.fc.hslf.record.Record[lst.size()]);
    ...
    public Slide removeSlide(int index)
    {
        ...
        ArrayList<kz.shprot.office.fc.hslf.record.Record> records = new ArrayList<kz.shprot.office.fc.hslf.record.Record>();
        ...
        else
        {
            ...
            slwt.setChildRecord(records.toArray(new kz.shprot.office.fc.hslf.record.Record[records.size()]));
        }
        ...
        if (removedSlide != null)
        {
            ...
            if (notesId != 0)
            {
                ...
                records = new ArrayList<kz.shprot.office.fc.hslf.record.Record>();
                ...
                else
                {
                    ...
                    nslwt.setChildRecord(records.toArray(new kz.shprot.office.fc.hslf.record.Record[records.size()]));
                }
    ...
    public HeadersFooters getSlideHeadersFooters()
    {
        ...
        kz.shprot.office.fc.hslf.record.Record[] ch = _documentRecord.getChildRecords();
    ...
    public void dispose()
    {
        ...
        if (_records != null)
        {
            for (kz.shprot.office.fc.hslf.record.Record rd : _records)
            {
                rd.dispose();
            }
            _records = null;
        ...
        {
            for (kz.shprot.office.fc.hslf.record.Record rd : _mostRecentCoreRecords)
            {
                rd.dispose();
            }
    ...
    private kz.shprot.office.fc.hslf.record.Record[] _records;

    // Pointers to the most recent versions of the core records
    // (Document, Notes, Slide etc)
    private kz.shprot.office.fc.hslf.record.Record[] _mostRecentCoreRecords;
