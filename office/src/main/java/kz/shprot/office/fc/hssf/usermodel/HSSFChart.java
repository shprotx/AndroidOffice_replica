...
import kz.shprot.office.fc.hssf.formula.ptg.AreaPtgBase;
import kz.shprot.office.fc.hssf.formula.ptg.Ptg;
import kz.shprot.office.fc.hssf.record.BOFRecord;
import kz.shprot.office.fc.hssf.record.DimensionsRecord;
import kz.shprot.office.fc.hssf.record.EOFRecord;
import kz.shprot.office.fc.hssf.record.FooterRecord;
import kz.shprot.office.fc.hssf.record.HCenterRecord;
import kz.shprot.office.fc.hssf.record.HeaderRecord;
import kz.shprot.office.fc.hssf.record.PrintSetupRecord;
import kz.shprot.office.fc.hssf.record.ProtectRecord;
import kz.shprot.office.fc.hssf.record.RecordBase;
import kz.shprot.office.fc.hssf.record.SCLRecord;
import kz.shprot.office.fc.hssf.record.UnknownRecord;
import kz.shprot.office.fc.hssf.record.VCenterRecord;
...
import kz.shprot.office.fc.hssf.record.chart.ChartFormatRecord;
...
import kz.shprot.office.fc.hssf.record.chart.SeriesIndexRecord;
...
import kz.shprot.office.fc.hssf.util.CellRangeAddress;
import kz.shprot.office.fc.ss.util.CellRangeAddressBase;
import kz.shprot.office.ss.model.XLSModel.AWorkbook;
...
public final class HSSFChart extends HSSFSimpleShape {
	...
	private Map<SeriesTextRecord, kz.shprot.office.fc.hssf.record.Record> chartSeriesText = new HashMap<SeriesTextRecord, kz.shprot.office.fc.hssf.record.Record>();
	...
	public void createBarChart( HSSFWorkbook workbook, HSSFSheet sheet )
	{
		...
		List<kz.shprot.office.fc.hssf.record.Record> records = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();
	 ...
	 */
	private static int convetRecordsToSeriesByPostion(List<kz.shprot.office.fc.hssf.record.Record> records, HSSFChart chart, int seriesStart)
	{
        ...
        if (records.get(start) instanceof BeginRecord)
        {
            ...
            {
				kz.shprot.office.fc.hssf.record.Record r = records.get(start);
	 ...
	 * @return
	 */
	private static int convetRecordsToText(List<kz.shprot.office.fc.hssf.record.Record> records, HSSFChart chart, int seriesStart)
	{
	 ...
	 * @param chart
	 */
	public static void convertRecordsToChart(List<kz.shprot.office.fc.hssf.record.Record> records, HSSFChart chart)
	{
	    ...
	    int index = 0;
		kz.shprot.office.fc.hssf.record.Record r;
	    while(index < size)
	    {
	        r = records.get(index);
...
//	        	chart.series.get(chart.series.size() - 1).setTextRecord((TextRecord)r);
            ...
            else if (r instanceof kz.shprot.office.fc.hssf.record.Record)
            {
                if (chart != null)
                {
					kz.shprot.office.fc.hssf.record.Record record = (kz.shprot.office.fc.hssf.record.Record) r;
	 ...
	 * @return
	 */
	public Map<SeriesTextRecord, kz.shprot.office.fc.hssf.record.Record> getSeriesText()
	{
	...
	private void createAxisRecords( List<kz.shprot.office.fc.hssf.record.Record> records )
	{
	...
	public HSSFSeries createSeries() throws Exception {
		...
		for(final RecordBase record : seriesTemplate) {
			...
			kz.shprot.office.fc.hssf.record.Record newRecord = null;
			...
			} else if (record instanceof kz.shprot.office.fc.hssf.record.Record) {
				newRecord = (kz.shprot.office.fc.hssf.record.Record) ((kz.shprot.office.fc.hssf.record.Record)record).clone();
			}
