...
public final class WorkbookRecordList implements Iterable<kz.shprot.office.fc.hssf.record.Record> {
    private List<kz.shprot.office.fc.hssf.record.Record> records = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();
	...
	public void setRecords(List<kz.shprot.office.fc.hssf.record.Record> records) {
	...
	public kz.shprot.office.fc.hssf.record.Record get(int i) {
		return records.get(i);
	}

	public void add(int pos, kz.shprot.office.fc.hssf.record.Record r) {
		records.add(pos, r);
	...
	public List<kz.shprot.office.fc.hssf.record.Record> getRecords() {
		return records;
	}

	public Iterator<kz.shprot.office.fc.hssf.record.Record> iterator() {
