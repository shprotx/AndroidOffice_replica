...
public final class SlideListWithText extends RecordContainer
{
    ...
    protected SlideListWithText(byte[] source, int start, int len)
    {
        ...
        // Find our children
        _children = kz.shprot.office.fc.hslf.record.Record.findChildRecords(source, start + 8, len - 8);
        ...
        for (int i = 0; i < _children.length; i++)
        {
            if (_children[i] instanceof SlidePersistAtom)
            {
                ...
                kz.shprot.office.fc.hslf.record.Record[] spaChildren = new kz.shprot.office.fc.hslf.record.Record[clen];
    ...
    public SlideListWithText()
    {
        ...
        _children = new kz.shprot.office.fc.hslf.record.Record[0];
    ...
    public void addSlidePersistAtom(SlidePersistAtom spa)
    {
        ...
        SlideAtomsSet newSAS = new SlideAtomsSet(spa, new kz.shprot.office.fc.hslf.record.Record[0]);
    ...
    */
    ...
    public class SlideAtomsSet
    {
        ...
        private kz.shprot.office.fc.hslf.record.Record[] slideRecords;
        ...
        public kz.shprot.office.fc.hslf.record.Record[] getSlideRecords()
        {
            return slideRecords;
        }

        /** Create one to hold the Records for one Slide's text */
        public SlideAtomsSet(SlidePersistAtom s, kz.shprot.office.fc.hslf.record.Record[] r)
        {
            slidePersistAtom = s;
            slideRecords = r;
        }
        ...
        public void dispose()
        {
            ...
            {
                for (kz.shprot.office.fc.hslf.record.Record rec : slideRecords)
                {
                    rec.dispose();
                }
                slideRecords = null;
