 ...
 * 时间:              下午2:21:40
 */
package kz.shprot.office.fc.xls;
...
import kz.shprot.office.fc.hssf.usermodel.HSSFCell;
import kz.shprot.office.fc.hssf.usermodel.HSSFChart;
import kz.shprot.office.fc.hssf.usermodel.HSSFChart.HSSFChartType;
import kz.shprot.office.fc.hssf.usermodel.HSSFChart.HSSFSeries;
import kz.shprot.office.fc.hssf.usermodel.HSSFDataFormat;
import kz.shprot.office.fc.hssf.usermodel.HSSFFormulaEvaluator;
import kz.shprot.office.fc.hssf.usermodel.HSSFName;
...
import kz.shprot.office.ss.model.XLSModel.ARow;
import kz.shprot.office.ss.model.XLSModel.ASheet;
...
import kz.shprot.office.ss.model.style.CellStyle;
import kz.shprot.office.ss.util.format.NumericFormatter;
import kz.shprot.office.thirdpart.achartengine.ChartFactory;
import kz.shprot.office.thirdpart.achartengine.chart.AbstractChart;
import kz.shprot.office.thirdpart.achartengine.chart.ColumnBarChart.Type;
import kz.shprot.office.thirdpart.achartengine.chart.PointStyle;
import kz.shprot.office.thirdpart.achartengine.model.CategorySeries;
import kz.shprot.office.thirdpart.achartengine.model.XYMultipleSeriesDataset;
import kz.shprot.office.thirdpart.achartengine.model.XYSeries;
import kz.shprot.office.thirdpart.achartengine.renderers.DefaultRenderer;
import kz.shprot.office.thirdpart.achartengine.renderers.SimpleSeriesRenderer;
import kz.shprot.office.thirdpart.achartengine.renderers.XYMultipleSeriesRenderer;
import kz.shprot.office.thirdpart.achartengine.renderers.XYSeriesRenderer;
import kz.shprot.office.thirdpart.achartengine.util.MathHelper;
...
//                else
        ...
        while(iter.hasNext())
        {
            ...
            kz.shprot.office.fc.hssf.record.Record r = chartSeriesText.get(seriesTextRecord);
...
//            
    ...
    private Map<SeriesTextRecord, kz.shprot.office.fc.hssf.record.Record> chartSeriesText;
    double minY, maxY;
}
