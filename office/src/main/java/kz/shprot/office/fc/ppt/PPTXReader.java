...
import kz.shprot.office.constant.wp.AttrIDConstant;
...
import kz.shprot.office.fc.openxml4j.opc.ContentTypes;
import kz.shprot.office.fc.openxml4j.opc.PackagePart;
import kz.shprot.office.fc.openxml4j.opc.PackageRelationship;
import kz.shprot.office.fc.openxml4j.opc.PackageRelationshipCollection;
...
import kz.shprot.office.fc.ppt.reader.HyperlinkReader;
import kz.shprot.office.fc.ppt.reader.LayoutReader;
import kz.shprot.office.fc.ppt.reader.MasterReader;
import kz.shprot.office.fc.ppt.reader.PictureReader;
import kz.shprot.office.fc.ppt.reader.ReaderKit;
import kz.shprot.office.fc.ppt.reader.SmartArtReader;
import kz.shprot.office.fc.ppt.reader.StyleReader;
import kz.shprot.office.fc.ppt.reader.TableStyleReader;
...
import kz.shprot.office.system.StopReaderError;
...
public class PPTXReader extends AbstractReader {
        ...
        try {
            ...
            if (tableStyleParts.size() > 0) {
                ...
                if (tableStylePackagePart != null) {
                    ...
                    new TableStyleReader().read(pgModel, tableStylePackagePart, fontsize);
                }
            }
    ...
    public boolean isReaderFinish() {
        return (!(pgModel != null && sldIds != null) || abortReader ||
                pgModel.getSlideCount() == 0 ||
                currentReaderIndex >= sldIds.size())
                && isReaderFinish;
    }
...
//        processGroupShapeID(grpShape);
    ...
    public void dispose() {
        if (isReaderFinish()) {
            Log.d(getClass().getPackage().getName(), "dispose");
            super.dispose();
