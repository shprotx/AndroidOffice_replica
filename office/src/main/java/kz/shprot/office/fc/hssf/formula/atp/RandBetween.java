...
==================================================================== */
package kz.shprot.office.fc.hssf.formula.atp;


import kz.shprot.office.fc.hssf.formula.OperationEvaluationContext;
...
final class RandBetween implements FreeRefFunction{
	 ...
	 * than top.
	 * 
	 * @see FreeRefFunction#evaluate(kz.shprot.office.fc.hssf.formula.eval.ValueEval[], OperationEvaluationContext)
	 */
