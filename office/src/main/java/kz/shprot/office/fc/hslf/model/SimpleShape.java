...
import kz.shprot.office.fc.hslf.exceptions.HSLFException;
...
//            double height = anchor.getHeight() / scale;
     ...
     */
    protected kz.shprot.office.fc.hslf.record.Record getClientDataRecord(int recordType)
    {
        kz.shprot.office.fc.hslf.record.Record[] records = getClientRecords();
        if (records != null)
        {
     ...
     */
    protected kz.shprot.office.fc.hslf.record.Record[] getClientRecords()
    {
        if (_clientData == null)
        {
        ...
        if (_clientData != null && _clientRecords == null)
        {
            ...
            _clientRecords = kz.shprot.office.fc.hslf.record.Record.findChildRecords(data, 0, data.length);
        }
    ...
    public void dispose()
    {
       ...
       {
           for (kz.shprot.office.fc.hslf.record.Record rec : _clientRecords)
           {
               rec.dispose();
           }
           _clientRecords = null;
     ...
     */
    protected kz.shprot.office.fc.hslf.record.Record[] _clientRecords;
