 ...
 * @see kz.shprot.office.fc.hssf.eventusermodel.HSSFRequest
...
public abstract class AbortableHSSFListener implements HSSFListener
{
   ...
   /**
     ...
     */
    public abstract short abortableProcessRecord(kz.shprot.office.fc.hssf.record.Record record) throws HSSFUserException;
}
