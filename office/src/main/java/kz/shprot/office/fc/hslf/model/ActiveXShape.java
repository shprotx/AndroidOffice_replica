...
import kz.shprot.office.fc.hslf.record.OEShapeAtom;
...
*/
     ...
     *
     * @see kz.shprot.office.fc.hslf.usermodel.SlideShow#addMovie(String, int)
    ...
    public ExControl getExControl()
    {
        ...
        if (lst != null)
        {
            kz.shprot.office.fc.hslf.record.Record[] ch = lst.getChildRecords();
