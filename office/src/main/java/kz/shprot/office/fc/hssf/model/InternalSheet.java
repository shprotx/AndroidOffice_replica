...
import kz.shprot.office.fc.hssf.record.CFHeaderRecord;
import kz.shprot.office.fc.hssf.record.CalcCountRecord;
import kz.shprot.office.fc.hssf.record.CalcModeRecord;
import kz.shprot.office.fc.hssf.record.CellValueRecordInterface;
import kz.shprot.office.fc.hssf.record.ColumnInfoRecord;
import kz.shprot.office.fc.hssf.record.ContinueRecord;
import kz.shprot.office.fc.hssf.record.DVALRecord;
import kz.shprot.office.fc.hssf.record.DefaultColWidthRecord;
import kz.shprot.office.fc.hssf.record.DefaultRowHeightRecord;
import kz.shprot.office.fc.hssf.record.DeltaRecord;
import kz.shprot.office.fc.hssf.record.DimensionsRecord;
import kz.shprot.office.fc.hssf.record.DrawingRecord;
import kz.shprot.office.fc.hssf.record.EOFRecord;
import kz.shprot.office.fc.hssf.record.EscherAggregate;
import kz.shprot.office.fc.hssf.record.FeatHdrRecord;
import kz.shprot.office.fc.hssf.record.FeatRecord;
import kz.shprot.office.fc.hssf.record.GridsetRecord;
import kz.shprot.office.fc.hssf.record.GutsRecord;
import kz.shprot.office.fc.hssf.record.IndexRecord;
import kz.shprot.office.fc.hssf.record.IterationRecord;
import kz.shprot.office.fc.hssf.record.MergeCellsRecord;
import kz.shprot.office.fc.hssf.record.NoteRecord;
import kz.shprot.office.fc.hssf.record.ObjRecord;
import kz.shprot.office.fc.hssf.record.PaneRecord;
import kz.shprot.office.fc.hssf.record.PrintGridlinesRecord;
import kz.shprot.office.fc.hssf.record.PrintHeadersRecord;
import kz.shprot.office.fc.hssf.record.Record;
import kz.shprot.office.fc.hssf.record.RecordBase;
import kz.shprot.office.fc.hssf.record.RefModeRecord;
import kz.shprot.office.fc.hssf.record.RowRecord;
import kz.shprot.office.fc.hssf.record.SCLRecord;
import kz.shprot.office.fc.hssf.record.SaveRecalcRecord;
import kz.shprot.office.fc.hssf.record.SelectionRecord;
import kz.shprot.office.fc.hssf.record.TextObjectRecord;
import kz.shprot.office.fc.hssf.record.UncalcedRecord;
import kz.shprot.office.fc.hssf.record.WSBoolRecord;
import kz.shprot.office.fc.hssf.record.WindowTwoRecord;
import kz.shprot.office.fc.hssf.record.aggregates.ChartSubstreamRecordAggregate;
import kz.shprot.office.fc.hssf.record.aggregates.ColumnInfoRecordsAggregate;
import kz.shprot.office.fc.hssf.record.aggregates.ConditionalFormattingTable;
import kz.shprot.office.fc.hssf.record.aggregates.CustomViewSettingsRecordAggregate;
import kz.shprot.office.fc.hssf.record.aggregates.DataValidityTable;
import kz.shprot.office.fc.hssf.record.aggregates.MergedCellsTable;
import kz.shprot.office.fc.hssf.record.aggregates.PageSettingsBlock;
import kz.shprot.office.fc.hssf.record.aggregates.RecordAggregate;
import kz.shprot.office.fc.hssf.record.aggregates.RecordAggregate.PositionTrackingVisitor;
import kz.shprot.office.fc.hssf.record.aggregates.RecordAggregate.RecordVisitor;
import kz.shprot.office.fc.hssf.record.aggregates.RowRecordsAggregate;
import kz.shprot.office.fc.hssf.record.aggregates.WorksheetProtectionBlock;
import kz.shprot.office.fc.hssf.record.chart.ChartRecord;
import kz.shprot.office.fc.hssf.usermodel.HSSFChart;
import kz.shprot.office.fc.hssf.util.ColumnInfo;
import kz.shprot.office.fc.hssf.util.HSSFPaneInformation;
import kz.shprot.office.fc.ss.util.HSSFCellRangeAddress;
 ...
 *
 * @see kz.shprot.office.fc.hssf.model.InternalWorkbook
 * @see kz.shprot.office.fc.hssf.usermodel.HSSFSheet
 */
@ Internal
public final class InternalSheet
{
     ...
     * @see kz.shprot.office.fc.hssf.record.DefaultColWidthRecord
     * @see kz.shprot.office.fc.hssf.record.ColumnInfoRecord
    ...
    */
     ...
     *
     * @see kz.shprot.office.fc.hssf.record.SelectionRecord
     ...
     */
    public kz.shprot.office.fc.hssf.record.Record findFirstRecordBySid(short sid)
    {
    ...
    public HSSFChart getChart()
	{
    	if(sheetType == BOFRecord.TYPE_CHART)
    	{
        	...
        	if(loc >= 0)
        	{
        		List<Record> chartRecordsList = new ArrayList<kz.shprot.office.fc.hssf.record.Record>();
