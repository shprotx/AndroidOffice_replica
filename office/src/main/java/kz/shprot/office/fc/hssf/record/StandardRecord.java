...
import kz.shprot.office.fc.util.LittleEndianByteArrayOutputStream;
 ...
 * @author Josh Micich
 */
public abstract class StandardRecord extends kz.shprot.office.fc.hssf.record.Record {
	 ...
	 *
	 * The subclass must write the exact number of bytes as reported by {@link kz.shprot.office.fc.hssf.record.Record#getRecordSize()}}
	 */
