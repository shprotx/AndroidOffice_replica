...
package kz.shprot.office.fc.hslf.model;
...
import kz.shprot.office.fc.hslf.record.EscherTextboxWrapper;
import kz.shprot.office.fc.hslf.record.InteractiveInfo;
import kz.shprot.office.fc.hslf.record.InteractiveInfoAtom;
import kz.shprot.office.fc.hslf.record.OEPlaceholderAtom;
import kz.shprot.office.fc.hslf.record.OutlineTextRefAtom;
import kz.shprot.office.fc.hslf.record.PPDrawing;
import kz.shprot.office.fc.hslf.record.RecordTypes;
import kz.shprot.office.fc.hslf.record.RoundTripHFPlaceholder12;
import kz.shprot.office.fc.hslf.record.StyleTextPropAtom;
import kz.shprot.office.fc.hslf.record.TextCharsAtom;
import kz.shprot.office.fc.hslf.record.TextHeaderAtom;
import kz.shprot.office.fc.hslf.record.TextRulerAtom;
import kz.shprot.office.fc.hslf.record.TxInteractiveInfoAtom;
...
public abstract class TextShape extends SimpleShape
{
    ...
    public TextRun createTextRun()
    {
        ...
        if (_txtrun == null)
        {
            ...
            _txtrun._records = new kz.shprot.office.fc.hslf.record.Record[]{tha, tca, sta};
            _txtrun.setText("");
    ...
    public byte getMetaCharactersType()
    {
        ...
        {
            kz.shprot.office.fc.hslf.record.Record[] children = clientTextBox.getChildRecords();
            for (int i = 0; i < children.length; i++)
            {
                if (children[i] != null)
                {
                	...
                	{
                		return kz.shprot.office.common.shape.TextBox.MC_SlideNumber;
                	}
                	else if (rType == RecordTypes.DateTimeMCAtom.typeID)
                	{
                		return kz.shprot.office.common.shape.TextBox.MC_DateTime;
                	}
                	else if(rType == RecordTypes.GenericDateMCAtom.typeID)
                    {
                        return kz.shprot.office.common.shape.TextBox.MC_GenericDate;
                    }
                	else if(rType == RecordTypes.RTFDateTimeMCAtom.typeID)
                    {
                        return kz.shprot.office.common.shape.TextBox.MC_RTFDateTime;
                    }
                	else if(rType == RecordTypes.FooterMCAtom.typeID)
                    {
                        return kz.shprot.office.common.shape.TextBox.MC_Footer;
                    }
                }
            }
        }
    ...
    */
    ...
    protected void initTextRun()
    {
        ...
        kz.shprot.office.fc.hslf.record.Record[] child = txtbox.getChildRecords();
        ...
        if (_txtrun != null)
            for (int i = 0; i < child.length; i++)
            {
                ...
                for (kz.shprot.office.fc.hslf.record.Record r : _txtrun.getRecords())
                {
     ...
     * @see kz.shprot.office.fc.hslf.usermodel.SlideShow#addHyperlink(Hyperlink)
     */
