...
import kz.shprot.office.fc.hssf.record.RecordFactoryInputStream;
...
public class HSSFEventFactory {
   ...
   public short abortableProcessWorkbookEvents(HSSFRequest req, POIFSFileSystem fs)
	 ...
	 *
	 * @see kz.shprot.office.fc.poifs.filesystem.POIFSFileSystem#createDocumentInputStream(String)
	 * @param req an Instance of HSSFRequest which has your registered listeners
	...
	private short genericProcessEvents(HSSFRequest req, InputStream in)
		...
		while(true) {
			kz.shprot.office.fc.hssf.record.Record r = recordStream.nextRecord();
			if(r == null) {
				break;
			}
