...
import kz.shprot.office.fc.hslf.record.DocumentEncryptionAtom;
...
public final class EncryptedSlideShow
{
    ...
    public static DocumentEncryptionAtom fetchDocumentEncryptionAtom(HSLFSlideShow hss)
    {
        ...
        if (cua.getCurrentEditOffset() != 0)
        {
            ...
            kz.shprot.office.fc.hslf.record.Record r = null;
            try
            {
                r = kz.shprot.office.fc.hslf.record.Record.buildRecordAtOffset(hss.getUnderlyingBytes(),
            ...
            kz.shprot.office.fc.hslf.record.Record r2 = kz.shprot.office.fc.hslf.record.Record.buildRecordAtOffset(hss.getUnderlyingBytes(),
            ...
            int offset = ((Integer)pph.getSlideLocationsLookup().get(Integer.valueOf(maxSlideId)))
                .intValue();
            kz.shprot.office.fc.hslf.record.Record r3 = kz.shprot.office.fc.hslf.record.Record.buildRecordAtOffset(hss.getUnderlyingBytes(), offset);
