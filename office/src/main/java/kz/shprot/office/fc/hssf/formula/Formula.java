...
import kz.shprot.office.fc.hssf.formula.ptg.TblPtg;
import kz.shprot.office.fc.ss.util.CellReference;
import kz.shprot.office.fc.util.LittleEndian;
import kz.shprot.office.fc.util.LittleEndianByteArrayInputStream;
import kz.shprot.office.fc.util.LittleEndianInput;
...
public class Formula {
	...
	/**
	 * Gets the locator for the corresponding {@link kz.shprot.office.fc.hssf.record.SharedFormulaRecord},
     * {@link kz.shprot.office.fc.hssf.record.ArrayRecord} or {@link kz.shprot.office.fc.hssf.record.TableRecord}
