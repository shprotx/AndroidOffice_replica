...
import kz.shprot.office.fc.hslf.record.HeadersFootersAtom;
...
public final class HeadersFooters
{
    ...
    private void attach()
    {
        ...
        kz.shprot.office.fc.hslf.record.Record[] ch = doc.getChildRecords();
        kz.shprot.office.fc.hslf.record.Record lst = null;
