...
import kz.shprot.office.fc.ddf.EscherChildAnchorRecord;
...
{    
    public static HSSFShape createShape(AWorkbook workbook, Map<EscherRecord, kz.shprot.office.fc.hssf.record.Record> shapeToObj,
    ...
    public static HSSFShapeGroup createShapeGroup(AWorkbook workbook, Map<EscherRecord, kz.shprot.office.fc.hssf.record.Record> shapeToObj,
                  EscherContainerRecord spContainer, HSSFShape parent)
    {
    ...
    public static HSSFShape createSimpeShape(AWorkbook workbook, Map<EscherRecord, kz.shprot.office.fc.hssf.record.Record> shapeToObj,
                  EscherContainerRecord spContainer, HSSFShape parent)
    {
        ...
        switch (type)
        {
            case ShapeTypes.TextBox:
                if (shapeToObj != null && shapeToObj.size() > 0)
                {
                    ...
                    kz.shprot.office.fc.hssf.record.Record record = shapeToObj.get(escherClientDataRecord);
