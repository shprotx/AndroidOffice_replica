 ...
 * 时间:              下午2:29:36
 */
package kz.shprot.office.constant;
...
public final class MainConstant {
    // app界面
    public static double appWidth = 0;// 宽度
    public static double appHeight = 0;// 高度
    // word应用
    ...
    /* ======= 以下定义一些视图公用常量 ========= */
    // DPI = 宽 / ((尺寸2 × 宽2) / (宽2 + 高2))1/2 = 长 / ((尺寸2 × 高2) / (宽2 + 高2))1/2 测试看看
    // Points DPI (72 pixels per inch)
    public static float POINT_DPI = 72.0f;// 这里默认值
    //厘米到磅
    ...
    // Pixels DPI
    public static float PIXEL_DPI = 96.f;
    // 磅到像素
    ...
    // normal draw callout
    public static final int DRAWMODE_NORMALDRAW = 3;
    // normal erase callout
    public static final int DRAWMODE_NORMALERASE = 4;
    public static final int DRAWMODE_NORMAL_NOT_DRAW = 5;
}
