...
package kz.shprot.office.system.beans;
...
{/*
    ...
    View.OnClickCallback mButtonHandler = new View.OnClickCallback()
    {
        ...
        public void handleMessage(Message msg)
        {
            switch (msg.what)
            {
                ...
                case DialogInterface.BUTTON_NEUTRAL:
                    ((DialogInterface.OnClickCallback)msg.obj).onClick(mDialog.get(), msg.what);
                    break;
    ...
    *//**
    ...
    public void setButton(int whichButton, CharSequence text,
        DialogInterface.OnClickCallback listener, Message msg)
    {
    ...
    *//**
    ...
    private boolean setupButtons()
    {
        ...
        mButtonPositive.setOnClickCallback(mButtonHandler);
        ...
        mButtonNegative.setOnClickCallback(mButtonHandler);
        ...
        mButtonNeutral.setOnClickCallback(mButtonHandler);
    ...
    public static class AlertParams
    {
        ...
        public DialogInterface.OnClickCallback mPositiveButtonListener;
        public CharSequence mNegativeButtonText;
        public DialogInterface.OnClickCallback mNegativeButtonListener;
        public CharSequence mNeutralButtonText;
        public DialogInterface.OnClickCallback mNeutralButtonListener;
        public boolean mCancelable;
        public DialogInterface.OnCancelListener mOnCancelListener;
        public DialogInterface.OnKeyListener mOnKeyListener;
        public CharSequence[] mItems;
        public ListAdapter mAdapter;
        public DialogInterface.OnClickCallback mOnClickListener;
        public View mView;
