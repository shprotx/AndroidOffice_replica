...
import kz.shprot.office.fc.xls.SSReader;
...
import kz.shprot.office.ss.util.ColorUtil;
import kz.shprot.office.system.AbstractReader;
import kz.shprot.office.system.IControl;
import kz.shprot.office.system.ReaderHandler;
 ...
 * <p>
 */
public class AWorkbook extends Workbook implements kz.shprot.office.fc.ss.usermodel.Workbook
{
    ...
    public AWorkbook(InputStream s, SSReader iAbortListener) throws IOException
    {
        ...
        List<kz.shprot.office.fc.hssf.record.Record> records = RecordFactory.createRecords(stream, iAbortListener);
     ...
     * @see kz.shprot.office.fc.hssf.record.LabelRecord
     * @see kz.shprot.office.fc.hssf.record.LabelSSTRecord
