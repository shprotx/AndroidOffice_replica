 ...
 * 时间:              下午1:55:20
 */
package kz.shprot.office.ss.model.XLSModel;
...
import kz.shprot.office.common.shape.AChart;
...
import kz.shprot.office.constant.SSConstant;
import kz.shprot.office.fc.hssf.model.InternalSheet;
import kz.shprot.office.fc.hssf.model.InternalWorkbook;
import kz.shprot.office.fc.hssf.record.BlankRecord;
...
import kz.shprot.office.fc.hssf.usermodel.HSSFAutoShape;
import kz.shprot.office.fc.hssf.usermodel.HSSFChart;
import kz.shprot.office.fc.hssf.usermodel.HSSFChildAnchor;
import kz.shprot.office.fc.hssf.usermodel.HSSFClientAnchor;
import kz.shprot.office.fc.hssf.usermodel.HSSFFreeform;
import kz.shprot.office.fc.hssf.usermodel.HSSFLine;
import kz.shprot.office.fc.hssf.usermodel.HSSFPatriarch;
import kz.shprot.office.fc.hssf.usermodel.HSSFPicture;
import kz.shprot.office.fc.hssf.usermodel.HSSFPictureData;
import kz.shprot.office.fc.hssf.usermodel.HSSFRichTextString;
import kz.shprot.office.fc.hssf.usermodel.HSSFShape;
import kz.shprot.office.fc.hssf.usermodel.HSSFShapeGroup;
import kz.shprot.office.fc.hssf.usermodel.HSSFSheet;
import kz.shprot.office.fc.hssf.usermodel.HSSFTextbox;
import kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook;
import kz.shprot.office.fc.hssf.util.HSSFPaneInformation;
import kz.shprot.office.fc.ss.util.HSSFCellRangeAddress;
import kz.shprot.office.fc.xls.ChartConverter;
import kz.shprot.office.java.awt.Rectangle;
import kz.shprot.office.ss.model.CellRangeAddress;
import kz.shprot.office.ss.model.baseModel.Cell;
import kz.shprot.office.ss.model.baseModel.Row;
import kz.shprot.office.ss.model.baseModel.Sheet;
import kz.shprot.office.ss.model.baseModel.Workbook;
import kz.shprot.office.ss.model.drawing.AnchorPoint;
import kz.shprot.office.ss.model.drawing.CellAnchor;
import kz.shprot.office.ss.model.sheetProperty.PaneInformation;
import kz.shprot.office.ss.util.ModelUtil;
import kz.shprot.office.ss.util.SectionElementFactory;
...
import kz.shprot.office.thirdpart.achartengine.chart.AbstractChart;
import kz.shprot.office.thirdpart.achartengine.chart.RoundChart;
import kz.shprot.office.thirdpart.achartengine.chart.XYChart;
import kz.shprot.office.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements kz.shprot.office.fc.ss.usermodel.Sheet
{
     ...
     * @see kz.shprot.office.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<kz.shprot.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<kz.shprot.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                kz.shprot.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                kz.shprot.office.ss.model.sheetProperty.ColumnInfo columnInfo = new kz.shprot.office.ss.model.sheetProperty.ColumnInfo(
