    ...
    implements Shape, java.io.Serializable
{
     ...
     * @see       #getBounds
     * @see	  java.awt.Component#setBounds(kz.shprot.office.java.awt.Rectangle)
     * @since     1.1
     */
     ...
     *                 along the Y axis
     * @see       kz.shprot.office.java.awt.Rectangle#setLocation(int, int)
     * @see       kz.shprot.office.java.awt.Rectangle#setLocation(java.awt.Point)
     */
     ...
     * @see       java.awt.Component#setSize(kz.shprot.office.java.awt.Dimension)
     * @see       #getSize
     * @since     1.1
     */
