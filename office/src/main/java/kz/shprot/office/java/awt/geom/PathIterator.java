...
package kz.shprot.office.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link kz.shprot.office.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link kz.shprot.office.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see kz.shprot.office.fc.hwpf.usermodel.Shape
 * @see kz.shprot.office.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
