...
import kz.shprot.office.constant.PDFConstant;
import kz.shprot.office.macro.DialogListener;
import kz.shprot.office.simpletext.control.SafeAsyncTask;
...
public class PDFFind implements IFind
{
    ...
    {        
        ...
        safeSearchTask.safeExecute(null,null);
    }
