...
//            }
        ...
        float endX, float endY, float fU)
   {
    ...
    private static ArrowPathAndTail buildArrowPath(float startX, float startY, float endX, float endY,
        float arrowWidth, float arrowLength, byte arrowType) 
    {
        ...
        return new ArrowPathAndTail();
    }
    
    private static ArrowPathAndTail buildTriangleArrowPath(float startX, float startY, float endX, float endY,
        float arrowWidth)
    {
        ArrowPathAndTail path = new ArrowPathAndTail();
        path.moveTo(endX, endY);
    ...
    private static ArrowPathAndTail buildArrowArrowPath(float startX, float startY, float endX, float endY,
        float arrowWidth)
    {
        ArrowPathAndTail path = new ArrowPathAndTail();
    ...
    private static ArrowPathAndTail buildDiamondArrowPath(float startX, float startY, float endX, float endY,
    ...
    private static ArrowPathAndTail buildStealthArrowPath(float startX, float startY, float endX, float endY,
        float arrowWidth, float arrowLength)
    {
        ArrowPathAndTail path = new ArrowPathAndTail();
        path.moveTo(endX, endY);
    ...
    private static ArrowPathAndTail buildOvalArrowPath(float endX, float endY, float arrowWidth, float arrowLength)
    {
        ArrowPathAndTail path = new ArrowPathAndTail();
